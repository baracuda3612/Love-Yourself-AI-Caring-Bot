...
def get_step_rationale(db: Session, step) -> str | None:
    ...
    payload = content.content_payload or {}

    # Rationale may be nested under payload["display"] after normalization.
    # Keep backward compatibility with legacy payloads.
    ...
    val = payload.get("scientific_rationale")
    return val or None
